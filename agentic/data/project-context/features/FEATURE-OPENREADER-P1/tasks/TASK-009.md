...
## Objective
ODF-005: let another app (file manager, WhatsApp, email, browser) hand a supported document to OpenReader via an Android intent, per BRD §7.7.
...
## Dependencies
Was blocked on at least one document reader existing. Cleared 2026-09-18: `FEATURE-OPENREADER-P2/tasks/TASK-010.md` (PDF), `FEATURE-OPENREADER-P3/tasks/TASK-011.md` (Word/Excel), and `FEATURE-OPENREADER-P4/tasks/TASK-012.md` (Text/CSV) all shipped the same day, unblocking this task for five of six categories. PowerPoint remains without a reader (blocked on its own undecided product question, `FEATURE-OPENREADER-P3/SRS.md` Unresolved Question 1) and is deliberately excluded from this task's intent-filters (see Implementation Requirements).
...
## References
- `agentic/data/project-context/features/OpenReader_BRD_v1.0.md` §7.7 (Open From Other Apps), §12.4 (incoming-intent corner case), §26 (never modify original file), §28 (ODF-005), §29 (clear app cache safely), §30 (Phase 4 exit criteria)
- `FEATURE-OPENREADER-P2/tasks/TASK-010.md`, `FEATURE-OPENREADER-P3/tasks/TASK-011.md`, `FEATURE-OPENREADER-P4/tasks/TASK-012.md` (the readers/dispatch seam this task hands off to)
