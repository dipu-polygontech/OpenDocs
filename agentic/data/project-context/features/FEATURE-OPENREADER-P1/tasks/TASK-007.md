...
## Dependencies
TASK-001 (index), TASK-004 (favorite-state pattern the Share/Info wiring follows). [ADR-OPENREADER-storage-access](../adr/ADR-OPENREADER-storage-access.md) — Accepted, no longer blocking.
