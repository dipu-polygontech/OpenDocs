...
## Dependencies
- `ADR-OPENREADER-pdf-library.md` — **Accepted**, `pdfrx: 2.4.8`.
...
## References
- `ADR-OPENREADER-pdf-library.md`
- `SRS.md`, `ARCHITECTURE.md` (original scoping this task implements)
- `FEATURE-OPENREADER-P1/tasks/TASK-007.md` (the `DocumentInteractionController`/accessibility-guard/test-pattern precedent reused here)
- `FEATURE-OPENREADER-P1/tasks/TASK-009.md` (Open From Other Apps — was blocked on "at least one document reader existing"; a PDF reader now exists, so that blocker is partially cleared for PDF files specifically, though TASK-009 itself is not implemented here)
