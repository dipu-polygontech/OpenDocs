# SRS-OPENREADER-P2: PDF Reader (BRD Phase 2)
...
## References
- `agentic/data/project-context/features/OpenReader_BRD_v1.0.md` §5, §6.5, §9.10, §10, §11 (Scenario 1), §12.2–12.6, §13, §14, §15, §16, §28 (ODF-008/011/012), §30 (Phase 2)
- `agentic/data/project-context/features/FEATURE-OPENREADER-P1/SRS.md`, `ARCHITECTURE.md`, `TECH-SPEC.md` (existing patterns this phase reuses)
