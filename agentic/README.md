...
The supplied runtime is a local reference implementation for trusted adapters. Replacing its plain-file persistence alone does not create production isolation, authenticated approvals, or hard cancellation. Those boundaries need organization-specific infrastructure; production actions are unsupported by this runtime.
